...
#define DICE_TRANSMIT_MESSAGE_UUID_128	{0x56, 0x34, 0xE0, 0xD1, 0x81, 0x54, 0x42, 0x10, 0x8E, 0xFF, 0xD2, 0xB3, 0x77, 0xE3, 0x2A, 0x77}
...
//    // Custom Service 1
    SVC1_IDX_SVC = 0,// Must be the first line because your characteristics must between two values in this case its between SVC1_IDX_SVC and CUSTS1_IDX_NB 
		...
		DICE_CHANGE_CHANCE_DECLARATION,
		DICE_CHANGE_CHANCE_VAL,
		DICE_CHANGE_CHANCE_CFG,
